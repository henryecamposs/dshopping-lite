...
export const IVARetentionPrint: React.FC<RetentionPrintProps> = ({ retention, companyInfo, providerInfo }) => {
  // Solo se visualiza al imprimir (@media print) o en modo vista previa de impresión
  return (
    <div className="hidden print:block p-8 font-sans text-black bg-white w-full">
      ...
      <div className="flex justify-between mb-8 border border-black p-4">
        <div>
          <p><strong>Nro. Comprobante:</strong> {retention.correlative_number}</p>
      ...
      <div className="mb-8 border border-black p-4">
        <h3 className="font-bold mb-2">Datos del Agente Retenido (Proveedor)</h3>
      ...
      <table className="w-full border-collapse border border-black mb-16 text-sm">
        <thead className="bg-gray-100">
          <tr>
            <th className="border border-black p-2">Nro. Factura</th>
            <th className="border border-black p-2">Nro. Control</th>
            <th className="border border-black p-2">Base Imponible</th>
            <th className="border border-black p-2">% IVA</th>
            <th className="border border-black p-2">Impuesto IVA</th>
            <th className="border border-black p-2">% Retención</th>
            <th className="border border-black p-2">IVA Retenido</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td className="border border-black p-2 text-center">F-001 (Mock)</td>
            <td className="border border-black p-2 text-center">C-001 (Mock)</td>
            <td className="border border-black p-2 text-right">Bs. --</td>
      ...
      <div className="flex justify-around mt-16 pt-16">
        ...
        <div className="text-center">
          <div className="border-t border-black w-48 mx-auto mt-8 pt-2">
            <strong>Firma Sujeto Retenido</strong>
          </div>
        </div>
      </div>
    </div>
